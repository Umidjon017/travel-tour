                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control bg-transparent" id="full_name" name="full_name" placeholder="Your Full Name">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <select class="form-select bg-transparent" id="select1" name="destination_id">
                                        @foreach($destinations as $destination)
                                        <option value="{{ $destination->id }}">
                                            {{ $destination->top_left_country_name ?: $destination->left_country_name ?: $destination->right_country_name }}
                                        </option>
                                        @endforeach
                                    </select>
